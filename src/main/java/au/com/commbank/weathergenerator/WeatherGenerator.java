...
public class WeatherGenerator {
	...
	/**
	 * This method generate a random position and a random date Based on that,
	 * it uses a Weather Forecaster to predict how the weather would be for that
	 * position and time
	 * 
	 * @param n
	 *            number of weathers to generate
