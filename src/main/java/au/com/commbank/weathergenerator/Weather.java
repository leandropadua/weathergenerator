...
/**
 * This class contains all the bundled information of the weather in a certain
 * location and time.
 * 
 * @author leandropadua
 */
public class Weather {
	...
	public String toString() {
		return String.format("%s|%.2f,%.2f,%d|%s|%s|%+.1f|%.1f|%d", location, position.getLatitude(),
				position.getLongitude(), position.getElevation(),
				new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'").format(datetime), condition, temperature, pressure,
				humidity);
	}
